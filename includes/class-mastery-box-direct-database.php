 ...
 */
class Mastery_Box_Direct_Database {
    ...
    public static function create_tables() {
        ...
        // Entries table - simplified for direct play
        $entries_table = $wpdb->prefix . 'masterybox_direct_entries';
    ...
    public static function get_gifts() {
        global $wpdb;
        $table_name = $wpdb->prefix . 'masterybox_direct_gifts';
